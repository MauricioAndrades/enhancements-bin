...
(function(csm) {
    ...
    var init_qtip_css = function(config) {
        ...
        return function e(t, n, r) {
            ...
            2: [function(require, module, exports) {
                ...
                require("browserify-css").createStyle(css, {href: "qtip.css"}, {insertAt: "bottom"});
                module.exports = css;
            }, {
                "browserify-css": 1
            }]
    ...
    var init_qtip_config = function(config) {
        var qtip_config = {
            content: {
                button: true,
                text: function(event, api) {                    var ul = document.createElement("ul");
    ...
    return (function() {
        ...
        csm.get_checkbox_state = function() {
            ...
            if (!check_boxes) {
                if(current_tab === "manage") {csm.create_checkbox.tags();}
                if (current_tab === "extensions") {csm.create_checkbox.customizations();}
            }
            if (check_boxes) {
        ...
        csm.add_info = function() {
            ...
            if (curr_tab === "manage") {
                ...
                window.setTimeout(function() {csm.qtip_init({force: true,debug: false});},100);
            }
        ...
        csm.init_view_state = function init_view_state() {try {var localData = JSON.parse(utui.util.storage.loadLocal(utui.login.email));} catch (e) {utui.util.storage.storeLocal(utui.login.email, JSON.stringify({tabState: {define: {}}}));}};
