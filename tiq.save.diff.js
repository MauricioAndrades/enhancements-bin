(function() {
  function saveDiff() {
    ...
    (function(global) {
      ...
      document.querySelectorAll(".diffleft").forEach(function(el, i) {
        left_data += el.textContent + "\n"
      });
      ...
      document.querySelectorAll(".diffright").forEach(function(el, i) {
        right_data += el.textContent + "\n"
      });
